// Сделал тесты по чеклисту, которые могут помочь
// оптимизировать время ваших проверок.

// Выводы не проверяются, только возвращаемые 
// значения. Все случаи неопределенного поведения помечены.
